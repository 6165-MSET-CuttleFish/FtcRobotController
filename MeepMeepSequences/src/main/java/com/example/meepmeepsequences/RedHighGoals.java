        ...
        MeepMeep mm = new MeepMeep(600)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d (-62, -56, Math.toRadians(0)))
                                ...
                                .lineToLinearHeading (new Pose2d (2, -56, Math.toRadians(180)))

                                /*
                                //case 0
                                .lineToLinearHeading(new Pose2d(-5, -59, Math.toRadians(180)))
                                .waitSeconds(0.8)
                                ...
                                /*
                                //case 1
                                .lineToLinearHeading(new Pose2d(24, -52, Math.toRadians(270)))
                                .waitSeconds(0.8)
                                ...
                                /*
                                //case 4
                                .lineToLinearHeading(new Pose2d(44,-59, Math.toRadians(180)))
                                .waitSeconds(0.8)
                                .lineToLinearHeading(new Pose2d(-12,-36, Math.toRadians(180)))
                                .lineTo(new Vector2d(-20, -36))
                                .waitSeconds (0.8)
