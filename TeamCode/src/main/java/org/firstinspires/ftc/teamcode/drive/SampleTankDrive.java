...
import org.firstinspires.ftc.teamcode.roadrunnerext.followers.ImprovedRamsete;
import org.firstinspires.ftc.teamcode.roadrunnerext.drive.ImprovedTankDrive;
 ...
 */
@Config
public class SampleTankDrive<T> extends ImprovedTankDrive<T> {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        super(hardwareMap, TRACK_WIDTH, hardwareMap.voltageSensor.iterator().next());
    ...
    public void setMotorPowers(double v, double v1) {
        ...
        for (DcMotorEx motor : leftMotors) {
            double pwr = (totalCharge < MID_CHARGE) ? v : v * (MAX_CHARGE - totalCharge) / MAX_CHARGE;
            motor.setPower(pwr);
        }
        for (int i = 0; i < rightMotors.size(); i++) {
            double pwr = (totalCharge < MID_CHARGE) ? v1 : v1 * (MAX_CHARGE - totalCharge) / MAX_CHARGE;
