...
public class Robot {
    ...
    public static Coordinate C = new Coordinate(102, 16);
    ...
    private void construct(DcMotor.RunMode runMode, HardwareMap imported, double robotLength, double robotWidth){
        ...
        pwrShots[0] = new Goal(144, 62.25, 23.5);
        pwrShots[1] = new Goal(144, 57.75, 23.5);
        pwrShots[2] = new Goal(144, 50.25, 23.5);
