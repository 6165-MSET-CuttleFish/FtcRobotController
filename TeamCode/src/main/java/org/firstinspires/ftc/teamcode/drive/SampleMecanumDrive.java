...
import org.firstinspires.ftc.teamcode.roadrunnerext.drive.ImprovedMecanumDrive;
import org.firstinspires.ftc.teamcode.roadrunnerext.followers.ImprovedHolonomicPIDVAFollower;
...
import static org.firstinspires.ftc.teamcode.Robot.MAX_CHARGE;
import static org.firstinspires.ftc.teamcode.Robot.MID_CHARGE;
 ...
 */
@Config
public class SampleMecanumDrive<T> extends ImprovedMecanumDrive<T> {
    ...
    private TrajectorySequenceRunner<T> trajectorySequenceRunner;

    private static final TrajectoryVelocityConstraint VEL_CONSTRAINT = getVelocityConstraint(MAX_VEL, MAX_ANG_VEL, TRACK_WIDTH);
    private static final TrajectoryAccelerationConstraint ACCEL_CONSTRAINT = getAccelerationConstraint(MAX_ACCEL);

    private ImprovedTrajectoryFollower follower;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        super(hardwareMap, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);
        follower = new ImprovedHolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.5, 0.5, Math.toRadians(5.0)), new Pose2d(0.5, 0.5, Math.toRadians(5.0)), 0.5);
    ...
    public void setPIDFCoefficients(@NonNull DcMotor.RunMode runMode, PIDFCoefficients coefficients) {
    ...
    public void setMotorPowers(double v, double v1, double v2, double v3) {
        double multiplier = (totalCharge < MID_CHARGE) ? 1 : (MAX_CHARGE - totalCharge) / MAX_CHARGE;
