...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.238; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.94;//0.26; // in; offset of the lateral wheel
