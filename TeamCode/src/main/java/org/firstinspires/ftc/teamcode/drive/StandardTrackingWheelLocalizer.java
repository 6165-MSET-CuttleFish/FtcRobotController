...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.28996;//643819061; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5.8;//0.26; // in; offset of the lateral wheel
