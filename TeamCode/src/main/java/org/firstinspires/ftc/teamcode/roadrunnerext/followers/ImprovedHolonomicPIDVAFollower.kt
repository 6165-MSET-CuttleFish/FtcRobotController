...
class ImprovedHolonomicPIDVAFollower @JvmOverloads constructor(
    ...
    override fun followTrajectory(trajectory: Trajectory, offset: Double) {
        axialController.reset()
        lateralController.reset()
        headingController.reset()

        super.followTrajectory(trajectory, offset)
    }
    ...
    override fun internalUpdate(currentPose: Pose2d, currentRobotVel: Pose2d?): DriveSignal {
        ...
        lastError = poseError
        lastVelocityError = targetRobotVel - (currentRobotVel ?: Pose2d())
